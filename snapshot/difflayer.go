...
func (h destructBloomHasher) Sum64() uint64 {
	return binary.BigEndian.Uint64(h.Hash[bloomDestructHasherOffset : bloomDestructHasherOffset+8])
}
...
func (h accountBloomHasher) Sum64() uint64 {
	return binary.BigEndian.Uint64(h.Hash[bloomAccountHasherOffset : bloomAccountHasherOffset+8])
}
...
func (h storageBloomHasher) Sum64() uint64 {
	return binary.BigEndian.Uint64(h[0].Hash[bloomStorageHasherOffset:bloomStorageHasherOffset+8]) ^
		binary.BigEndian.Uint64(h[1].Hash[bloomStorageHasherOffset:bloomStorageHasherOffset+8])
}
